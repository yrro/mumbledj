...
func (suite *AudioQueueTestSuite) TestAddNewTrack() {
	suite.Zero(len(suite.Queue.Queue), "The queue should be empty.")
	suite.Queue.AddTracks(MockedAudioTrack{})
...
func (suite *AudioQueueTestSuite) TestCurrentTrack() {
	...
	suite.Queue.AddTracks(suite.FirstTrack)
...
func (suite *AudioQueueTestSuite) TestPeekNextTrack() {
	...
	suite.Queue.AddTracks(suite.SecondTrack)
...
func (suite *AudioQueueTestSuite) TestShuffleTracks() {
	...
	suite.Queue.AddTracks(suite.ThirdTrack)
	suite.Queue.AddTracks(MockedAudioTrack{Identifier: "fourth"})
	suite.Queue.AddTracks(MockedAudioTrack{Identifier: "fifth"})
